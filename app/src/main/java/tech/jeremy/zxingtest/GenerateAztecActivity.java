...
public class GenerateAztecActivity extends AppCompatActivity implements OnClickListener {
      ...
      public static void start ( Context context ) {
            ...
            Intent starter = new Intent( context, GenerateAztecActivity.class );
      ...
      protected void onCreate ( Bundle savedInstanceState ) {
            ...
            setContentView( R.layout.activity_generate_aztec );
            initView();
      }
      ...
      public void onClick ( View v ) {
            ...
            switch( v.getId() ) {
                  ...
                  case R.id.decode:
                        if( mBitmap != null ) {
                              Result result = ZXingManager.decodeAztec( mBitmap );
                              if( result != null ) {
